...
See the redis documentation for background information about
pipelining.  In short, evaluating
...
Note the warnings about pipeline in the official Redis
documentation - sending so many commands (e.g., >10k) memory use on
the server can be negatively affected.
